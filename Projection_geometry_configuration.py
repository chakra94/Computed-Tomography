...
class proj_geom():
    ...
    detector_height = 64.5 # [mm]
    detector_width = detector_pixel_size # [mm]
    proj_per_helix = 9   # Number of samples taken from a complete 360 degree rotation
    detector_cards = 19   # number of detector cards in a single detector box setup
    ...
    angles = np.linspace(0, 2*np.pi, num=proj_per_helix, endpoint=False)   # Uniform sampling over 360 degree angle
